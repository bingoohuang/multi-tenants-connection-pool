...
import static com.github.bingoohuang.mtcp.pool.TestElf.isJava9;
    ...
    public static class FauxWebContext {
        ...
        public void createConcurrentBag() throws InterruptedException {
            try (val bag = new ConcurrentBag<>((x) -> CompletableFuture.completedFuture(Boolean.TRUE))) {
                ...
                BagEntry borrowed = bag.borrow(100, MILLISECONDS);
                bag.requite(borrowed);

                BagEntry removed = bag.borrow(100, MILLISECONDS);
                bag.remove(removed);
            }
