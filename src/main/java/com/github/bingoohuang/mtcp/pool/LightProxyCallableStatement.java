...
public class LightProxyCallableStatement extends ProxyPreparedStatement implements CallableStatement {
    ...
    protected LightProxyCallableStatement(ProxyConnection var1, CallableStatement var2) {
        super(var1, var2);
    }
}
