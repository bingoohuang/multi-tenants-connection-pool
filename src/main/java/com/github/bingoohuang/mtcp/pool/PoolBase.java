...
abstract class PoolBase {
   ...
   void registerMBeans(final LightPool lightPool) {
      ...
      try {
         ...
         final ObjectName beanConfigName = new ObjectName("com.github.bingoohuang.mtcp:type=PoolConfig (" + poolName + ")");
         final ObjectName beanPoolName = new ObjectName("com.github.bingoohuang.mtcp:type=Pool (" + poolName + ")");
