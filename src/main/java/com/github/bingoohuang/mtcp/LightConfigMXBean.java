...
/**
 * The javax.management MBean for a Light pool configuration.
 *
 * @author Brett Wooldridge
 */
public interface LightConfigMXBean {
    /**
     ...
     * including both idle and in-use connections. If the idle connections dip below this value, LightCP will
